...
Here are some sample maps made in Lingtypology for R with the Daghestanian villages and languages dataset.

See the RMD file in the repository for the code used to draw these maps.
